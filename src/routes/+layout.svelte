...
<footer class="bg-primary text-white py-12">
  <div class="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
    <div>
      <h3 class="font-montserrat text-xl mb-4">HIGH<span class="text-gold">POINT</span></h3>
      ...
      <div class="flex space-x-4 mt-4">
        ...
        <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" class="text-white hover:text-gold">
